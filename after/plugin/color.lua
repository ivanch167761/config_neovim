...
--	vim.cmd.colorscheme(color)
	...
	vim.api.nvim_set_hl(0, "GitSignsDeleteInline", {fg="NONE", bg="NONE", ctermfg="NONE", ctermbg="NONE", sp="#E7C547", bold = (vim.g.aurora_bold==1), undercurl= true })
	vim.api.nvim_set_hl(0, "GitSignsChangeInline", {fg="NONE", bg="NONE", ctermfg="NONE", ctermbg="NONE", sp="#B376B3", bold = (vim.g.aurora_bold==1), undercurl= true })
	...
	vim.api.nvim_set_hl(0, "jsGlobalNodeObjects", {fg="#2ba245", bg="NONE", ctermfg=35, ctermbg="NONE",  bold = (vim.g.aurora_bold==1)})
	...
	vim.api.nvim_set_hl(0, "plugH2", {fg="#5ca7e4", bg="NONE", ctermfg=74, ctermbg="NONE",  bold = (vim.g.aurora_bold==1)})
	...
	vim.api.nvim_set_hl(0, "cStorageClass", {fg="#50B4DC", bg="NONE", ctermfg=74, ctermbg="NONE",  bold = (vim.g.aurora_bold==1)})
	vim.api.nvim_set_hl(0, "cCustomClass", {fg="#b4b0e0", bg="NONE", ctermfg=146, ctermbg="NONE",  bold = (vim.g.aurora_bold==1)})
	vim.api.nvim_set_hl(0, "cCustomMemVar", {fg="#50c878", bg="NONE", ctermfg=78, ctermbg="NONE",  bold = (vim.g.aurora_bold==1)})
	...
	vim.api.nvim_set_hl(0, "cStatement", {fg="#F92772", bg="NONE", ctermfg=197, ctermbg="NONE",  bold = (vim.g.aurora_bold==1)})
	...
	vim.api.nvim_set_hl(0, "cAnsiFunction", {fg="#DDCFBF", bg="NONE", ctermfg=187, ctermbg="NONE",  bold = (vim.g.aurora_bold==1)})
	vim.api.nvim_set_hl(0, "cRepeat", {link= "Repeat"})
	vim.api.nvim_set_hl(0, "cSpecial", {fg="#333042", bg="NONE", ctermfg=236, ctermbg="NONE",  bold = (vim.g.aurora_bold==1)})
	...
	vim.api.nvim_set_hl(0, "markdownHeadingRule", {fg="#f05874", bg="NONE", ctermfg=204, ctermbg="NONE",  bold = (vim.g.aurora_bold==1)})
	vim.api.nvim_set_hl(0, "markdownHeadingDelimiter", {fg="#f05874", bg="NONE", ctermfg=204, ctermbg="NONE",  bold = (vim.g.aurora_bold==1)})
	...
	vim.api.nvim_set_hl(0, "markdownUrlTitleDelimiter", {fg="#fbed7d", bg="NONE", ctermfg=228, ctermbg="NONE",  })
	...
	vim.api.nvim_set_hl(0, "ClapMatches", {fg="#C33C4A", bg="#443a54", ctermfg=131, ctermbg=238, sp="#f05874", bold = (vim.g.aurora_bold==1), undercurl= true , reverse= true })
	vim.api.nvim_set_hl(0, "ClapDisplay", {fg="#aab7cf", bg=bg, ctermfg=146, ctermbg=234, sp="#f05874", bold = (vim.g.aurora_bold==1), undercurl= true })
	...
	vim.api.nvim_set_hl(0, "TSError", {fg="#DC143C", bg="NONE", ctermfg=161, ctermbg="NONE",  bold = (vim.g.aurora_bold==1), undercurl= true })
	vim.api.nvim_set_hl(0, "TSPunctDelimiter", {fg="#e7d3fb", bg="NONE", ctermfg=189, ctermbg="NONE",  bold = (vim.g.aurora_bold==1)})
	...
	vim.api.nvim_set_hl(0, "TSDefinition", {link= "Definition"})
	vim.api.nvim_set_hl(0, "TSStrong", {fg="#DBC08A",  ctermfg=180,   bold = (vim.g.aurora_bold==1)})
	vim.api.nvim_set_hl(0, "TSEmphasis", {fg="#fbed7d",  ctermfg=228,   bold = (vim.g.aurora_bold==1), undercurl= true , italic= true })
	...
	vim.api.nvim_set_hl(0, "javaScriptLineComment", {fg="#637077",  ctermfg=243,   italic = (vim.g.aurora_italic==1)})
	...
	vim.api.nvim_set_hl(0, "LightspeedLabel", {fg="#e7d3fb", bg="#57109a", ctermfg=189, ctermbg=54, sp="#ecc48d", bold = (vim.g.aurora_bold==1), undercurl= true , italic= true })
	...
	vim.api.nvim_set_hl(0, "LightspeedLabelDistantOverlapped", {fg="NONE", bg="#DC143C", ctermfg="NONE", ctermbg=161,  })
	vim.api.nvim_set_hl(0, "LightspeedShortcut", {fg="#EE82EE",  ctermfg=213,   bold = (vim.g.aurora_bold==1), undercurl= true })
	vim.api.nvim_set_hl(0, "LightspeedShortcutOverlapped", {fg="#EE82EE",  ctermfg=213,   bold = (vim.g.aurora_bold==1), undercurl= true })
	vim.api.nvim_set_hl(0, "LightspeedMaskedChar", {fg="#ff5874",  ctermfg=204,   bold = (vim.g.aurora_bold==1), undercurl= true })
	vim.api.nvim_set_hl(0, "LightspeedGreyWash", {fg="#989cbf",  ctermfg=247,   italic = (vim.g.aurora_italic==1)})
	vim.api.nvim_set_hl(0, "LightspeedUnlabeledMatch", {fg="#F92772",  ctermfg=197,   bold = (vim.g.aurora_bold==1), italic= true })
	vim.api.nvim_set_hl(0, "LightspeedOneCharMatch", {fg="#f19bb6",  ctermfg=211,   bold = (vim.g.aurora_bold==1), italic= true })
	vim.api.nvim_set_hl(0, "LightspeedUniqueChar", {fg="#d7ffaf",  ctermfg=193,   bold = (vim.g.aurora_bold==1)})
	vim.api.nvim_set_hl(0, "LightspeedPendingOpArea", {fg="#66d9ef",  ctermfg=81,   bold = (vim.g.aurora_bold==1), undercurl= true })
	vim.api.nvim_set_hl(0, "LightspeedPendingChangeOpArea", {fg="#d7ffaf",  ctermfg=193,   bold = (vim.g.aurora_bold==1)})
	vim.api.nvim_set_hl(0, "LightspeedCursor", {fg="#ffbbd6", bg="#22202a", ctermfg=218, ctermbg=235,  })
	vim.api.nvim_set_hl(0, "HopNextKey", {fg="#EE82EE",  ctermfg=213,   bold = (vim.g.aurora_bold==1), underline= true })
	vim.api.nvim_set_hl(0, "HopNextKey1", {fg="#ecc48d",  ctermfg=222,   bold = (vim.g.aurora_bold==1), underline= true })
	...
	vim.api.nvim_set_hl(0, "IndentBlanklineContextStart", {fg="#c4a2ff",  ctermfg=183,  sp="#c4a2ff", bold = (vim.g.aurora_bold==1), underline= true })
	...
	vim.api.nvim_set_hl(0, "DiagnosticError", {fg="#ac3f27", bg="NONE", ctermfg=130, ctermbg="NONE",  })
	...
	vim.api.nvim_set_hl(0, "DiagnosticWarningFloating", {fg="#DBC08A", bg="NONE", ctermfg=180, ctermbg="NONE",  })
	vim.api.nvim_set_hl(0, "DiagnosticVirtualTextError", {fg="#D93234", bg="NONE", ctermfg=167, ctermbg="NONE",  })
	...
	vim.api.nvim_set_hl(0, "LspReferenceText", { bg="#343047",  ctermbg=239, sp="#FD9720", bold = (vim.g.aurora_bold==1), undercurl= true })
	vim.api.nvim_set_hl(0, "LspReferenceRead", {fg="#1aad16",  ctermfg=34,  sp="#FD9720", bold = (vim.g.aurora_bold==1), undercurl= true })
	vim.api.nvim_set_hl(0, "LspReferenceWrite", {fg="#1aad16",  ctermfg=34,  sp="#FD9720", bold = (vim.g.aurora_bold==1), undercurl= true })
	vim.api.nvim_set_hl(0, "LspFloatWinNormal", {fg="#dacfb4", bg="#30234f", ctermfg=187, ctermbg=236,  })
	vim.api.nvim_set_hl(0, "LspSignatureActiveParameter", {fg="NONE", bg="#4d0c5d", ctermfg="NONE", ctermbg=53, sp="#fbec9f", bold = (vim.g.aurora_bold==1), underline= true , italic= true })
	...
	vim.api.nvim_set_hl(0, "goBuiltins", {fg="#01d5f1", bg="NONE", ctermfg=45, ctermbg="NONE",  bold = (vim.g.aurora_bold==1), italic= true })
	vim.api.nvim_set_hl(0, "goConditional", {fg="#EE82EE", bg="NONE", ctermfg=213, ctermbg="NONE",  })
	vim.api.nvim_set_hl(0, "goDeclType", {fg="#9e71cf", bg="NONE", ctermfg=134, ctermbg="NONE",  bold = (vim.g.aurora_bold==1)})
	...
	vim.api.nvim_set_hl(0, "goSameId", {fg="NONE", bg="#343047", ctermfg="NONE", ctermbg=236,  bold = (vim.g.aurora_bold==1), undercurl= true , italic= true })
	vim.api.nvim_set_hl(0, "goPredefinedIdentifiers", {fg="#CD5C5C",  ctermfg=167,   italic = (vim.g.aurora_italic==1)})
	...
	vim.api.nvim_set_hl(0, "LineNr", {fg="#5f496e", bg=bg, ctermfg=239, ctermbg=234,  })
	...
	vim.api.nvim_set_hl(0, "DiffAdd", {fg="NONE", bg="#2f223e", ctermfg="NONE", ctermbg=239,  bold = (vim.g.aurora_bold==1)})
	vim.api.nvim_set_hl(0, "DiffChange", {fg="NONE", bg=bg2, ctermfg="NONE", ctermbg=236,  bold = (vim.g.aurora_bold==1)})
	vim.api.nvim_set_hl(0, "DiffDelete", {fg="NONE", bg="#3f4060", ctermfg="NONE", ctermbg=239,  })
	vim.api.nvim_set_hl(0, "DiffText", {fg="NONE", bg="#420010", ctermfg="NONE", ctermbg=89,  bold = (vim.g.aurora_bold==1), italic= true , underline= true })
	...
	vim.api.nvim_set_hl(0, "PMenuSel", {fg="#e7d3fb", bg="#443a54", ctermfg=189, ctermbg=238,  bold = (vim.g.aurora_bold==1), italic= true })
	vim.api.nvim_set_hl(0, "PMenuKind", {fg="#1ABC9C", bg="#443a54", ctermfg=189, ctermbg=238,  bold = (vim.g.aurora_bold==1), italic= true })
	vim.api.nvim_set_hl(0, "PMenuExtra", {fg="#10aef8", bg="#443a54", ctermfg=189, ctermbg=238,  bold = (vim.g.aurora_bold==1), italic= true })
	...
	vim.api.nvim_set_hl(0, "Search", {fg="NONE", bg="#3f4060", ctermfg="NONE", ctermbg=239, sp="#EE82EE", bold = (vim.g.aurora_bold==1), underline= true , italic= true })
	...
	vim.api.nvim_set_hl(0, "SpellRare", {fg="#99c794", bg="NONE", ctermfg=114, ctermbg="NONE", sp="#addb67", undercurl = true})
	...
	vim.api.nvim_set_hl(0, "TabLineSel", {fg="#10aef8", bg="NONE", ctermfg=39, ctermbg="NONE",  underline = true})
	...
	vim.api.nvim_set_hl(0, "Include", {fg="#D57CD5",  ctermfg=176,   })
	vim.api.nvim_set_hl(0, "Define", {fg="#ff5874",  ctermfg=204,   bold = (vim.g.aurora_bold==1)})
	...
	vim.api.nvim_set_hl(0, "Tag", {fg="#addb67",  ctermfg=149,   })
	vim.api.nvim_set_hl(0, "htmlTag", {fg="#637077", bg="NONE", ctermfg=243, ctermbg="NONE",  })
	vim.api.nvim_set_hl(0, "htmlEndTag", {link= "htmlTag"})
	vim.api.nvim_set_hl(0, "Delimiter", {fg="#A1EFE4",  ctermfg=158,   })
	...
	vim.api.nvim_set_hl(0, "Error", {fg="#DC143C", bg="NONE", ctermfg=161, ctermbg="NONE", sp="#e7dc8c", bold = (vim.g.aurora_bold==1), undercurl= true })
	vim.api.nvim_set_hl(0, "Todo", {fg="#e73c50", bg="#6D3B66", ctermfg=167, ctermbg=242,  bold = (vim.g.aurora_bold==1), underline= true })
	...
	vim.api.nvim_set_hl(0, "typescriptInterfaceKeyword", {fg="#9ece6a", bg="NONE", ctermfg=149, ctermbg="NONE",  })
	...
	vim.api.nvim_set_hl(0, "diffRemoved", {fg="#f05874", bg="NONE", ctermfg=204, ctermbg="NONE",  bold = (vim.g.aurora_bold==1)})
	vim.api.nvim_set_hl(0, "diffChanged", {fg="#4cc7e4", bg="NONE", ctermfg=80, ctermbg="NONE",  bold = (vim.g.aurora_bold==1)})
	vim.api.nvim_set_hl(0, "diffAdded", {fg="#9dd067", bg="NONE", ctermfg=149, ctermbg="NONE",  bold = (vim.g.aurora_bold==1)})
	vim.api.nvim_set_hl(0, "diffLine", {fg="#fbed7d", bg="NONE", ctermfg=228, ctermbg="NONE",  bold = (vim.g.aurora_bold==1)})
	vim.api.nvim_set_hl(0, "diffSubname", {fg="#7fdbca", bg="NONE", ctermfg=116, ctermbg="NONE",  bold = (vim.g.aurora_bold==1)})
